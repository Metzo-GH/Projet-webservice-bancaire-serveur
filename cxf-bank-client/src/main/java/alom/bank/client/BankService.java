...
public interface BankService {
    ...
    @WebResult(name = "return", targetNamespace = "")
    public alom.bank.client.Compte retirerArgent(
    ...
    @WebResult(name = "return", targetNamespace = "")
    public alom.bank.client.Compte ajouterArgent(
    ...
    @WebResult(name = "return", targetNamespace = "")
    public alom.bank.client.Compte connaitreSolde(
